...
using PrimFunct =
    std::function<Expr(const std::string &name, const Expr args, std::shared_ptr<SymbolTable> a)>;
using PrimFullFunct = std::function<Expr(Evaluator &l, const std::string &name, const Expr args,
