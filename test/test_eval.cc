...
TEST(eval, atom) {
    std::vector<TestEval> tests = {
        {"(atom t)", "t"},          {"(atom nil)", "t"},
        {"(atom (quote x))", "t"},  {"(atom (quote (a b)))", "nil"},

        {"(atom t)", "t"},          {"(atom ())", "t"},
        {"(atom (cdr '(a)))", "t"}, {"(atom (cdr '(a b)))", "nil"},

        {"(atom #\\c)", "t"},

        {"(atom 1)", "t"},          {"(atom 1.273)", "t"},
...
TEST(eval, cons) {
    std::vector<TestEval> tests = {
        ...
        {"(cons 'all (cons (cons 'these (cons 'problems '())) '()))", "(all (these problems))"},
...
TEST(eval, const) {
    std::vector<TestEval> tests = {
        ...
        {"(defconstant \"s\" 'd)",
         "Eval error: defconstant requires a symbol as a first argument"},
        {"(defconstant n1 100 n2 200 )",
         "Eval error: defconstant only takes maximum of 3 arguments"},
...
TEST(eval, case) {
    std::vector<TestEval> tests = {
        {"(case 0 (0 'zero) (1 'one) (2 'two) (otherwise 'unknown))", "zero"},
        {"(case 1 (0 'zero) (1 'one) (2 'two) (otherwise 'unknown))", "one"},
        {"(case 2 (0 'zero) (1 'one) (2 'two) (otherwise 'unknown))", "two"},
        {"(case 3 (0 'zero) (1 'one) (2 'two) (otherwise 'unknown))", "unknown"},

        {"(case 'α (α 'alpha) (β 'beta) (γ 'gamma) (otherwise 'greek))", "alpha"},
        {"(case 'β (α 'alpha) (β 'beta) (γ 'gamma) (otherwise 'greek))", "beta"},
        {"(case 'γ (α 'alpha) (β 'beta) (γ 'gamma) (otherwise 'greek))", "gamma"},
        {"(case 'δ (α 'alpha) (β 'beta) (γ 'gamma) (otherwise 'greek))", "greek"},
        {"(case 'δ (α 'alpha) (β 'beta) (γ 'gamma))", "nil"},
...
TEST(eval, progn) {
    std::vector<TestEval> tests = {
        {"(progn 'α 'β 'γ 'δ)", "δ"}, {"(progn '🍎 '🍐 '🍊 '🍌)", "🍌"},
        {"(progn 4)", "4"},           {"(progn (atom 'a) (atom '(a v)))", "nil"},
        {"(progn)", "nil"},
    };
    test_Evaluator(tests);
}
...
TEST(eval, prog1) {
    std::vector<TestEval> tests = {
        {"(prog1'α 'β 'γ 'δ)", "α"}, {"(prog1 '🍎 '🍐 '🍊 '🍌)", "🍎"},
        {"(prog1 4)", "4"},          {"(prog1 (atom 'a) (atom '(a v)))", "t"},
        {"(prog1)", "nil"},
    };
    test_Evaluator(tests);
}
